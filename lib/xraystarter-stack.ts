...
export class XraystarterStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const fnTS = new NodejsFunction(this, "adotstarter-ts", {
      ...
      layers: [aws_lambda.LayerVersion.fromLayerVersionArn(this, "layerts", layerTS)],
      architecture: aws_lambda.Architecture.X86_64,
    });

    fnTS.addToRolePolicy(
    ...
    const fnPy = new PythonFunction(this, "adotstarter-py", {
      ...
      layers: [aws_lambda.LayerVersion.fromLayerVersionArn(this, "layerpy", layerPy)],
      tracing: aws_lambda.Tracing.ACTIVE,
    });
    ...
    const fnGO = new aws_lambda.Function(this, "adotstarter-go", {
      ...
      timeout: Duration.seconds(3),
      logRetention: aws_logs.RetentionDays.ONE_MONTH,
      layers: [aws_lambda.LayerVersion.fromLayerVersionArn(this, "layerGO", layerGo)],
